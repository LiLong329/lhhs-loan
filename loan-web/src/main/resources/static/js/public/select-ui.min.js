...
(function($) {
    ...
    $.uedWidget('ued.uedSelect', {
        ...
        _createSelect : function($el) {
			...
			//··设置组件宽度
			var widthTemp=$el.attr("width")||$el.css("width")||options.width;
			//var width = parseInt(widthTemp) ? parseInt(widthTemp) : options.width;
			//$el.width(width);
			$el.css({"width":"100%"}).closest(".vocation").css({"width":widthTemp});
