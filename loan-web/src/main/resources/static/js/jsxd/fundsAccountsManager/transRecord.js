$(function(){	
	...
	function queryList(obj){
		$.post("/userFundsAccountsManager/ajaxTransRecord",obj,function(data){
			$("#recordList").html("").html(data);
		});
	};
	$("#recordList").on("click","#export",function(){
		var obj=$("#myForm").serialize();
		window.location.href="/userFundsAccountsManager/exportTransRecord?"+obj;
	});
