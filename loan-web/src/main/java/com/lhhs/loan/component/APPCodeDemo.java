...
public class APPCodeDemo {
    ...
    public static void main(String[] args) throws Exception {
		...
		String imgFile = "blob:http://localhost:8085/d93f1dfc-af0a-4d5e-9939-0852d38c8b13";
		...
		// String config_str = "";
		// 对图像进行base64编码
		String imgBase64 = demo.getImg(imgFile);
		String result = demo.imgAnalyze(imgBase64, is_old_format, configObj);
