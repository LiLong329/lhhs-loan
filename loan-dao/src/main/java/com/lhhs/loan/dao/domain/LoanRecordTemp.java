...
public class LoanRecordTemp extends BaseObject{
   
	private static final long serialVersionUID = 6353854416974418602L;
    ...
    private String rate;//借款利率
    
    private String customerName;//借款人姓名
    
    private String customerNatureName;//客户性质名称
