 ...
 * File Name:PayFinishedExcelVo.java
 * Package Name:com.lhhs.loan.dao.domain.excel
 * Date:2017年8月24日下午12:29:33
...
/**
 * ClassName:PayFinishedExcelVo <br/>
 * Function: 已还清记录列表 <br/>
 * Date:     2017年8月24日 下午12:29:33 <br/>
 * @author   xiangfeng
 * @version
 * @since    JDK 1.8
 * @see
 */
public class PayFinishedExcelVo {
    ...
    @Excel(name = "实际还清时间", orderNum = "15",exportFormat = "yyyy/MM/dd")
