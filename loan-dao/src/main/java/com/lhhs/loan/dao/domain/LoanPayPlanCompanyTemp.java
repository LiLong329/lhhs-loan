...
public class LoanPayPlanCompanyTemp {
    private Long id;
    ...
    private String outPropertyName;//客户性质
    	
    private BigDecimal financialAmount;//理财金额
    
    private BigDecimal financialInterestRate;//理财利率
    
    private String financialInterestRateUnit;//理财利率单位
    
    private Date actualLendingTime;//放款时间
    
    private Date contractEndTime;//合同截止日期
    
    private String accountManagerName;//客户经理

    private String accountManagerDepartmentName;//部门
    
    private Long financialTerm;//理财期限
	...
	public void setFinancialInterestRateUnit(String financialInterestRateUnit) {
		this.financialInterestRateUnit = financialInterestRateUnit;
	}
